# CLIPPER BARBER STUDIO — FUENTE DE INFORMACIÓN PARA SITIO WEB

Este documento contiene únicamente información del negocio.

Usar esta información como fuente principal para construir el sitio web.

No asumir información adicional.
...
Nombre:
Clipper Barber Studio

Categoría:
Barbería

Dirección:
Av. Delante 479 – LOCAL 1
Cuauhtemoc
22890
...
Permitir que clientes puedan reservar citas directamente desde la página web.

La reserva debe reducir pasos manuales y conectarse con las herramientas que ya utiliza el negocio.
...
→ realiza pago en línea
→ la cita queda registrada automáticamente

El negocio actualmente utiliza Google Calendar para administrar citas.

El sitio debe considerar integración con Google Calendar para registrar automáticamente nuevas reservas.

También se desea integrar pagos en línea para automatizar el proceso de reserva.
...
# LISTA DE PRECIOS
(Fuente: imagen proporcionada por el negocio)
...
"La mejor barbería de Ensenada 💈🔥

Desde que marqué para agendar mi cita me atendieron súper rápido y con excelente servicio."
...
"Cada uno de sus barberos han demostrado su habilidad desde estilos con pelo."

---

# RESUMEN DE PERCEPCIÓN DEL NEGOCIO
(Basado únicamente en información entregada)
...
WhatsApp
Teléfono
Google Calendar (administración interna)

Objetivo:

Reserva desde sitio web
→ pago en línea
